...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2022"), "Cabo Frio vamos nós", "Cabo frio blz", maria);
		Post post2 = new Post(null, sdf.parse("22/03/2022"), "Boa Tarde!", "Muita Ressaca kkkk!", maria);
